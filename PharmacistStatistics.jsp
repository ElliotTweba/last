...
try{
	...
	if(resultSet.next()){
		map = new HashMap<Object,Object>();  map.put("label", "Panado");map.put("y", a); list.add(map);
                map = new HashMap<Object,Object>();  map.put("label", "Grand-PA");map.put("y", b); list.add(map);
                map = new HashMap<Object,Object>();  map.put("label", "Flue");map.put("y", c); list.add(map);
                map = new HashMap<Object,Object>();  map.put("label", "Panado");map.put("y", d); list.add(map);
                map = new HashMap<Object,Object>();  map.put("label", "Panado");map.put("y", e); list.add(map);
                map = new HashMap<Object,Object>();  map.put("label", "Panado");map.put("y", f); list.add(map);
                map = new HashMap<Object,Object>();  map.put("label", "Panado");map.put("y", g); list.add(map);
                map = new HashMap<Object,Object>();  map.put("label", "Panado");map.put("y", h); list.add(map);
